...
const guarantees = [
  { icon: Wallet, title: "Гарантия вознаграждения", desc: "Размер вознаграждения зафиксирован в договоре. Выплаты — в течение 5 рабочих дней после успешного трудоустройства." },
